...
BMF_species_all_PCB_ng_glw
```

```{r}
write_xlsx(
  x = BMF_species_all_PCB_ng_glw, 
  path = "results/BMF_computation_PCB_ng_glw/1.BMF_species_all_PCB_ng_glw.xlsx")
```
...
```{r}
ggsave(
  filename = "results/BMF_computation_PCB_ng_glw/1.ggplot_BMF_species_PCB_all_ng_glw.jpg",
...
```{r}
ggsave(
  filename = "results/BMF_computation_PCB_ng_glw/1.ggplot_BMF_species_sumPCB_ng_glw.jpg",
...
write_xlsx(x = BMF_species_PCB_ng_glw_summarised, 
           path = "results/BMF_computation_PCB_ng_glw/1.BMF_species_PCB_ng_glw_summarised.xlsx")
```

## Graph Mean BMF per CBs
```{r}
ggplot_BMF_species_PCB_ng_glw_summarised <- BMF_species_PCB_ng_glw_summarised |> 
  filter(PCB != "sumPCB") |> 
...
```{r}
ggsave(
  filename = "results/BMF_computation_PCB_ng_glw/1.ggplot_BMF_species_PCB_ng_glw_summarised.jpg",
