...
# PCB
benthos_contam$sommePCB_ALL_ng_gdw <- apply(benthos_contam[,paste(PCB_ALL,"_ng_gdw",sep="")],
                                            MARGIN = 1, FUN = sum, na.rm = TRUE)
benthos_contam[, paste(PCB_ALL, "normalised_sum_ALL_ng_gdw", sep = "_")] <- benthos_contam[, paste(PCB_ALL, "_ng_gdw", sep = "")] / benthos_contam$sommePCB_ALL_ng_gdw

# PFAS
benthos_contam$sommePFAS_ALL_ng_gdw <- apply(benthos_contam[,paste(PFAS_ALL,"_ng_gdw",sep="")],
                                            MARGIN = 1, FUN = sum, na.rm = TRUE)
benthos_contam[, paste(PFAS_ALL, "normalised_sum_ALL_ng_gdw", sep = "_")] <- benthos_contam[, paste(PFAS_ALL,"_ng_gdw",sep="")] /  benthos_contam$sommePFAS_ALL_ng_gdw

# PFAS censored
benthos_contam$sommePFAS_ALL_ng_gdw_censored <- apply(benthos_contam[,paste(PFAS_ALL,"_ng_gdw_censored",sep="")],
                                                     MARGIN = 1, FUN = sum, na.rm = TRUE)
benthos_contam[, paste(PFAS_ALL, "normalised_sum_ALL_ng_gdw_censored", sep = "_")] <- benthos_contam[, paste(PFAS_ALL,"_ng_gdw_censored",sep="")] / benthos_contam$sommePFAS_ALL_ng_gdw_censored

# HBCDD
benthos_contam$sommeHBCDD_ALL_ng_gdw <- apply(benthos_contam[,paste(HBCDD_ALL,"_ng_gdw",sep="")],
                                             MARGIN = 1, FUN = sum, na.rm = TRUE)
benthos_contam[, paste(HBCDD, "normalised_sum_ALL_ng_gdw", sep = "_")] <- benthos_contam[, paste(HBCDD_ALL, "_ng_gdw", sep = "")] / benthos_contam$sommeHBCDD_ALL_ng_gdw

# HBCDD censored
benthos_contam$sommeHBCDD_ALL_ng_gdw_censored <- apply(benthos_contam[,paste(HBCDD_ALL,"_ng_gdw_censored",sep="")],
                                                      MARGIN = 1, FUN = sum, na.rm = TRUE)
benthos_contam[, paste(HBCDD, "normalised_sum_ALL_ng_gdw_censored", sep = "_")] <- benthos_contam[, paste(HBCDD_ALL, "_ng_gdw_censored", sep = "")] / benthos_contam$sommeHBCDD_ALL_ng_gdw_censored
...
for(c in 1:length(PCB_ALL)){
  benthos_contam[,paste(PCB_ALL[c],"_ng_glw",sep="")] <- benthos_contam[,paste(PCB_ALL[c],"_ng_gdw",sep="")]/(benthos_contam$lip_dw_percent/100)
}
benthos_contam$sommePCB_ALL_ng_glw = apply(benthos_contam[,paste(PCB_ALL,"_ng_glw",sep="")], MARGIN = 1, FUN = sum, na.rm = TRUE)
benthos_contam$sommePCBindicators_ng_glw = apply(benthos_contam[,paste(PCB_indicators,"_ng_glw",sep="")], MARGIN = 1, FUN = sum, na.rm = TRUE)
benthos_contam$sommePCBdioxineL_ng_glw = apply(benthos_contam[,paste(inter_dioxineL,"_ng_glw",sep="")], MARGIN = 1, FUN = sum, na.rm = TRUE)
...
# PCB
for(c in 1:length(PCB_ALL)){
  benthos_contam[,paste(PCB_ALL[c],"_ng_gww",sep="")] = benthos_contam[,paste(PCB_ALL[c],"_ng_gdw",sep="")]*((benthos_contam$dw_percent)/100)
}
benthos_contam$sommePCB_ALL_ng_gww = apply(benthos_contam[,paste(PCB_ALL,"_ng_gww",sep="")], MARGIN = 1, FUN = sum, na.rm = TRUE)
benthos_contam$sommePCBindicators_ng_gww = apply(benthos_contam[,paste(PCB_indicators,"_ng_gww",sep="")], MARGIN = 1, FUN = sum, na.rm = TRUE)
benthos_contam$sommePCBdioxineL_ng_gww = apply(benthos_contam[,paste(inter_dioxineL,"_ng_gww",sep="")], MARGIN = 1, FUN = sum, na.rm = TRUE)

# PFAS
for(c in 1:length(PFAS_ALL)){
  benthos_contam[,paste(PFAS_ALL[c],"_ng_gww",sep="")] = benthos_contam[,paste(PFAS_ALL[c],"_ng_gdw",sep="")]*((benthos_contam$dw_percent)/100)
}
benthos_contam$sommePFAS_ALL_ng_gww = apply(benthos_contam[,paste(PFAS_ALL,"_ng_gww",sep="")], MARGIN = 1, FUN = sum, na.rm = TRUE)

# PFAS censored
for(c in 1:length(PFAS_ALL)){
  benthos_contam[,paste(PFAS_ALL[c],"_ng_gww_censored",sep="")] = benthos_contam[,paste(PFAS_ALL[c],"_ng_gdw_censored",sep="")]*((benthos_contam$dw_percent)/100)
}
benthos_contam$sommePFAS_ALL_ng_gww_censored = apply(benthos_contam[,paste(PFAS_ALL,"_ng_gww_censored",sep="")], MARGIN = 1, FUN = sum, na.rm = TRUE)

# HBCDD
for(c in 1:length(HBCDD_ALL)){
  benthos_contam[,paste(HBCDD_ALL[c],"_ng_gww",sep="")] = benthos_contam[,paste(HBCDD_ALL[c],"_ng_gdw",sep="")]*((benthos_contam$dw_percent)/100)
}
benthos_contam$sommeHBCDD_ALL_ng_gww = apply(benthos_contam[,paste(HBCDD_ALL,"_ng_gww",sep="")], MARGIN = 1, FUN = sum, na.rm = TRUE)

# HBCDD censored
for(c in 1:length(HBCDD_ALL)){
  benthos_contam[,paste(HBCDD_ALL[c],"_ng_gww_censored",sep="")] = benthos_contam[,paste(HBCDD_ALL[c],"_ng_gdw_censored",sep="")]*((benthos_contam$dw_percent)/100)
}
benthos_contam$sommeHBCDD_ALL_ng_gww_censored = apply(benthos_contam[,paste(HBCDD_ALL,"_ng_gww_censored",sep="")], MARGIN = 1, FUN = sum, na.rm = TRUE)
